...
const DEFAULT_QUICK_FOODS = [
  ...
  { name: '一个鸡蛋', foodName: '鸡蛋', amount: 60, unit: 'g', kcal: 78, icon: '🥚', sortOrder: 2 },
  { name: '一杯牛奶', foodName: '牛奶', amount: 250, unit: 'ml', kcal: 162, icon: '🥛', sortOrder: 3 },
  { name: '一个苹果', foodName: '苹果', amount: 200, unit: 'g', kcal: 104, icon: '🍎', sortOrder: 4 },
  { name: '一份青菜', foodName: '青菜(炒)', amount: 200, unit: 'g', kcal: 60, icon: '🥬', sortOrder: 5 },
  { name: '一杯咖啡', foodName: '黑咖啡', amount: 240, unit: 'ml', kcal: 5, icon: '☕', sortOrder: 6 },
  { name: '一片面包', foodName: '全麦面包', amount: 40, unit: 'g', kcal: 98, icon: '🍞', sortOrder: 7 },
];
